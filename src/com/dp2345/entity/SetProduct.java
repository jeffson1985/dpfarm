...
public class SetProduct extends BaseEntity {
	/**
	 * 
	 */
	private static final long serialVersionUID = -367930230612326286L;

	/** 点击数缓存名称 */
	public static final String HITS_CACHE_NAME = "setproductHits";
	...
	static {
		try {
			...
			org.dom4j.Element element = (org.dom4j.Element) document.selectSingleNode("/dp2345/template[@id='productContent']");
