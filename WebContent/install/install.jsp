...
<title>DP2345安装程序 - Powered By CETVISION</title>
...
<body>
	<div class="header">
		<div class="title">DP2345 安装程序</div>
	...
	<script type="text/javascript">
		$().ready(function() {
				...
				$.ajax({
					...
					success: function(data) {
						if (data.status == "success") {
							...
							$installMessage.html('<div id="installSuccess" class="installSuccess"><strong>恭喜您，DP2345系统安装成功，请重新启动WEB服务器！<\/strong><span>基于安全考虑，请在安装成功后删除install目录<\/span><\/div>');
			...
			$complete.click( function() {
				alert("恭喜您,DP2345系统安装成功，请重新启动WEB服务器！");
			});
