...
<title>系统配置 - Powered CETVISION</title>
...
<body>
	<div class="header">
		<div class="title">DP2345 安装程序 - 系统配置</div>
			...
			<div class="bodyRight">
				<table>
					...
					<tr>
						<td>数据库名称:</td>
						<td>
							<input type="text" id="databaseName" name="databaseName" class="text" value="dp2345" maxlength="200" />
							<span class="requireField">*</span>
						</td>
					</tr>
				</table>
