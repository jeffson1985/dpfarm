...
<%
	...
	boolean isDp2345XmlCanWrite = isCanWrite(rootPath + "/WEB-INF/classes/dp2345.xml");
	boolean isDp2345PropertiesWrite = isCanWrite(rootPath + "/WEB-INF/classes/dp2345.properties");
	...
	String isDp2345XmlCanWriteInfo = null;
	if (isDp2345XmlCanWrite) {
		isDp2345XmlCanWriteInfo = "<span class=\"green\">√</span>";
	} else {
		isDp2345XmlCanWriteInfo = "<span class=\"red\">×</span>";
	}
	String isDp2345PropertiesInfo = null;
	if (isDp2345PropertiesWrite) {
		isDp2345PropertiesInfo = "<span class=\"green\">√</span>";
	} else {
		isDp2345PropertiesInfo = "<span class=\"red\">×</span>";
	}
...
<title>检查安装环境 - Powered By CETVISION</title>
...
$().ready( function() {
	...
	<%if ((freeSpace != 0 && freeSpace < 51200) || (maxMemory != 0 && maxMemory < 128) || !isDp2345XmlCanWrite || !isDp2345PropertiesWrite || !isWebXmlCanWrite || !isUploadCanWrite) { %>
		hasWarn = true;
	<% } %>
...
<body>
	<div class="header">
		<div class="title">DP2345 安装程序 - 环境检测</div>
	...
	<div class="body">
		...
		<div class="bodyRight">
			...
			<table>
				...
				<tr>
					<td>
						/WEB-INF/classes/dp2345.xml
					</td>
					<td>
						可写
					</td>
					<td>
						<%=isDp2345XmlCanWriteInfo%>
					</td>
				</tr>
				<tr>
					<td>
						/WEB-INF/classes/dp2345.properties
					</td>
					<td>
						可写
					</td>
					<td>
						<%=isDp2345PropertiesInfo%>
					</td>
				</tr>
				<tr>
					<td>
	...
	<div class="footer">
		<p class="copyright">Copyright © 2013-2015 dp2345.com All Rights Reserved.</p>
	</div>
</body>
</html>