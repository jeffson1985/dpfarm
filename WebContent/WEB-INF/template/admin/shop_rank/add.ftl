...
<title>${message("admin.shopRank.add")} - Powered By CETVISION</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.shopRank.add")}
	</div>
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="isDefault" value="true" />${message("ShopRank.isDefault")}
						<input type="hidden" name="_isDefault" value="false" />
					</label>
					<label title="${message("admin.shopRank.isSpecialTitle")}">
						<input type="checkbox" id="isSpecial" name="isSpecial" value="true" />${message("ShopRank.isSpecial")}
