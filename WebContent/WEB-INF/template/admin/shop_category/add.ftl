...
<title>${message("admin.shopCategory.add")} - Powered By CETVISION</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.shopCategory.add")}
	</div>
