...
<title>${message("admin.shopCategory.list")} - Powered By CETVISION</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.shopCategory.list")}
	</div>
	<div class="bar">
	...
	<table id="listTable" class="list">
		<tr>
			<th>
				<span>${message("ShopCategory.name")}</span>
			</th>
			<th>
		...
		[#list shopCategoryTree as shopCategory]
			<tr>
				<td>
					<span style="margin-left: ${shopCategory.grade * 20}px;[#if shopCategory.grade == 0] color: #000000;[/#if]">
						${shopCategory.name}
					</span>
				</td>
				<td>
