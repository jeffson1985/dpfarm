...
<title>${message("admin.index.title")} - Powered By CETVISION</title>
...
<body>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				<a href="http://www.CETVISION.COM" target="_blank">http://www.CETVISION.COM</a>
			</td>
			<th>
				${message("admin.index.bbs")}:
			</th>
			<td>
				<a href="http://bbs.CETVISION.COM" target="_blank">http://bbs.CETVISION.COM</a>
			</td>
		</tr>
		<tr>
			<td colspan="4">
