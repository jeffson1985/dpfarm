...
<title>${message("admin.main.title")} - Powered By CETVISION</title>
...
<body>
	...
	<table class="main">
		<tr>
			<th class="logo">
				<a href="main.jhtml">
					<img src="${base}/resources/admin/images/header_logo.gif" alt="CETVISION" />
				</a>
			</th>
			<th>
				...
				<div class="link">
					<a href="http://www.CETVISION.COM" target="_blank">${message("admin.main.official")}</a>|
					<a href="http://bbs.CETVISION.COM" target="_blank">${message("admin.main.bbs")}</a>|
					<a href="http://www.CETVISION.COM/about.html" target="_blank">${message("admin.main.about")}</a>
				</div>
				<div class="link">
