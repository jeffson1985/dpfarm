...
[#if productCategory??]
	[@seo type = "productList"]
		<title>[#if productCategory.seoTitle??]${productCategory.seoTitle}[#elseif seo.title??][@seo.title?interpret /][/#if][#if systemShowPowered] - Powered By CETVISION[/#if]</title>
	...
	[/@seo]
[#else]
	<title>${message("shop.product.title")}[#if systemShowPowered] - Powered By CETVISION[/#if]</title>
	<meta name="author" content="CETVISION Team" />
	<meta name="copyright" content="CETVISION" />
[/#if]
