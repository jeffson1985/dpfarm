...
<%@page import="com.dp2345.Setting"%>
<%@page import="com.dp2345.util.SettingUtils"%>
<%@page import="com.dp2345.util.SpringUtils"%>
<%@page import="com.dp2345.Setting.CaptchaType"%>
<%@page import="com.dp2345.Setting.AccountLockType"%>
<%@page import="com.dp2345.service.RSAService"%>
...
%>
<title><%=SpringUtils.getMessage("admin.login.title")%> - Powered By CETVISION</title>
...
<%} else {%>
<title>提示信息 - Powered By CETVISION</title>
<meta http-equiv="expires" content="0" />
<meta http-equiv="Pragma" content="no-cache" />
<meta http-equiv="Cache-Control" content="no-cache" />
<meta name="author" content="CETVISION Team" />
	...
	<%if (applicationContext != null) {%>
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=base%>/resources/admin/images/login_logo.gif" alt="甲东家庭农场" />
						</td>
						<th>
				...
				<div class="powered">COPYRIGHT © 2013-2015 DP2345.COM ALL RIGHTS RESERVED.</div>
				<div class="link">
					<a href="<%=base%>/"><%=SpringUtils.getMessage("admin.login.home")%></a> |
					<a href="http://www.dp2345.com"><%=SpringUtils.getMessage("admin.login.official")%></a> |
					<a href="http://bbs.dp2345.com"><%=SpringUtils.getMessage("admin.login.bbs")%></a> |
					<a href="http://www.dp2345.com/about.html"><%=SpringUtils.getMessage("admin.login.about")%></a> |
					<a href="http://www.dp2345.com/contact.html"><%=SpringUtils.getMessage("admin.login.contact")%></a> |
					<a href="http://www.dp2345.com/license.html"><%=SpringUtils.getMessage("admin.login.license")%></a>
				</div>
			</form>
		</div>
	<%} else {%>
		<fieldset>
			...
			<p>请检查甲东家庭农场程序是否已正确安装 [<a href="<%=base%>/install/">点击此处进行安装</a>]</p>
			<p>
				<strong>提示: 甲东家庭农场安装完成后必须重新启动WEB服务器</strong>
			</p>
		</fieldset>
	<%}%>
</body>
