/*
 * Copyright 2013-2015 dp2345.com. All rights reserved.
 * Support: http://www.dp2345.com
 * License: http://www.dp2345.com/license
 * 
 * JavaScript - Input
 * Version: 3.0
 */
...
if(typeof(KindEditor) != "undefined") {
	KindEditor.ready(function(K) {
		editor = K.create("#editor", {
			...
			langType: dp2345.locale,
			syncType: "form",
			filterMode: false,
			pagebreakHtml: '<hr class="pageBreak" \/>',
			allowFileManager: true,
			filePostName: "file",
			fileManagerJson: dp2345.base + "/admin/file/browser.jhtml",
			uploadJson: dp2345.base + "/admin/file/upload.jhtml",
